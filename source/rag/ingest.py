            ...
            documents.append(
                Document(
                    ...
                    metadata = dict(
                        ...
                        khoan = chunk.metadata['khoan'],
                        dieu = chunk.metadata['dieu'],
                        chuong = chunk.metadata['chuong'],
                        luat = chunk.metadata['luat'],
    ...
    def ingest_data_qdrant(
        ...
        payloads = [
            QdrantPayload(
                ...
                khoan = doc.metadata['khoan'],
                dieu = doc.metadata['dieu'],
                chuong = doc.metadata['chuong'],
                luat = doc.metadata['luat'],
